...
// dependency.
const linkBase =
  "block px-3 py-2 rounded-xl text-sm font-medium transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-400/60 focus:ring-offset-2 dark:focus:ring-offset-slate-950";
const hover = "hover:text-slate-900 dark:hover:text-white";
const isActive = (pathname: string, path: string) =>
  pathname === path
    ? "text-slate-900 dark:text-white font-semibold relative after:content-[''] after:absolute after:inset-x-3 after:-bottom-0.5 after:h-0.5 after:rounded-full after:bg-gradient-to-r after:from-amber-400 after:to-orange-600"
