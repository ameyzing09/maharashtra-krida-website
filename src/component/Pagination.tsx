      ...
      <ul className="flex justify-center space-x-2 mt-4">
        <li>
          <button
            ...
            className="bg-lime-400 hover:bg-lime-600 text-brand-charcoal font-bold py-2 px-4 rounded border border-black/10 focus:outline-none focus:shadow-outline transition duration-300 ease-in-out disabled:opacity-60"
          >
            Prev
          </button>
        </li>
          ...
          <li key={number} className="flex">
            <button
              ...
              className={`bg-lime-400 hover:bg-lime-600 font-bold py-2 px-4 rounded border border-black/10 focus:outline-none focus:shadow-outline transition duration-300 ease-in-out ${
                currentPage === number ? "bg-lime-600 text-white" : "text-brand-charcoal"
              }`}
            >
              {number}
            </button>
