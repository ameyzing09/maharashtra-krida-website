  ...
  return (
    <div className="h-screen p-4 flex flex-col items-center justify-center bg-brand-paper dark:bg-brand-charcoal text-brand-charcoal dark:text-gray-200">
      <div className="space-y-4 text-lg">
        ...
        <Link to="/menu/gallery-management" className="block px-6 py-2 rounded hover:bg-black/5 dark:hover:bg-white/10">Gallery Management</Link>
        <Link to="/menu/news-management" className="block px-6 py-2 rounded hover:bg-black/5 dark:hover:bg-white/10">News Management</Link>
